        ...
        <div className="grid relative gap-3 grid-cols-1 max-w-[600px]">
          ...
          {reddit && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/reddit-icon.svg" alt="Reddit" className="absolute left-6 h-6 w-6" draggable="false" />
              My Reddit
            </Link>
          )}
          ...
          {stackoverflow && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/stackoverflow-icon.svg" alt="Stack Overflow" className="absolute left-6 h-6 w-6" draggable="false" />
              My Stack Overflow
            </Link>
          )}
          ...
          {leetcode && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/leetcode-icon.svg" alt="LeetCode" className="absolute left-6 h-6 w-6" draggable="false" />
              My LeetCode
            </Link>
          )}
          ...
          {codeforces && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/codeforces-icon.svg" alt="Codeforces" className="absolute left-6 h-6 w-6" draggable="false" />
              My Codeforces
            </Link>
          )}
          ...
          {hackerrank && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/hackerrank-icon.svg" alt="HackerRank" className="absolute left-6 h-6 w-6" draggable="false" />
              My HackerRank
            </Link>
          )}
          ...
          {codechef && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/codechef-icon.svg" alt="CodeChef" className="absolute left-6 h-6 w-6" draggable="false" />
              My CodeChef
            </Link>
          )}
          ...
          {geeksForGeeks && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/gfg-icon.svg" alt="GeeksForGeeks" className="absolute left-6 h-6 w-6" draggable="false" />
              My GFG
            </Link>
          )}
          ...
          {twitch && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/twitch-icon.svg" alt="Twitch" className="absolute left-6 h-6 w-6" draggable="false" />
              My Twitch
            </Link>
          )}
          ...
          {soundcloud && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/soundcloud-icon.svg" alt="SoundCloud" className="absolute left-6 h-6 w-6" draggable="false" />
              My SoundCloud
            </Link>
          )}
          ...
          {spotify && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/spotify-icon.svg" alt="Spotify" className="absolute left-6 h-6 w-6" draggable="false" />
              My Spotify
            </Link>
          )}
          ...
          {applemusic && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/applemusic-icon.svg" alt="Apple Music" className="absolute left-6 h-6 w-6" draggable="false" />
              My Apple Music
            </Link>
          )}
          ...
          {discord && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/discord-icon.svg" alt="Discord" className="absolute left-6 h-6 w-6" draggable="false" />
              My Discord
            </Link>
          )}
          ...
          {telegram && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/telegram-icon.svg" alt="Telegram" className="absolute left-6 h-6 w-6" draggable="false" />
              My Telegram
            </Link>
          )}
          ...
          {whatsapp && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/whatsapp-icon.svg" alt="WhatsApp" className="absolute left-6 h-6 w-6" draggable="false" />
              My WhatsApp
            </Link>
          )}
          ...
          {skype && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/skype-icon.svg" alt="Skype" className="absolute left-6 h-6 w-6" draggable="false" />
              My Skype
            </Link>
          )}
          ...
          {amazon && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/amazon-icon.svg" alt="Amazon" className="absolute left-6 h-6 w-6" draggable="false" />
              My Amazon
            </Link>
          )}
          ...
          {shopify && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/shopify-icon.svg" alt="Shopify" className="absolute left-6 h-6 w-6" draggable="false" />
              My Shopify
            </Link>
          )}
          ...
          {kofi && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/kofi-icon.svg" alt="Ko-Fi" className="absolute left-6 h-6 w-6" draggable="false" />
              Ko-fi Tip
            </Link>
          )}
          ...
          {buyMeACoffee && (
            <Link
              ...
              className="w-full transition md:w-[420px] sm:w-[300px] mx-auto h-14 bg-secondary flex items-center justify-center rounded-lg hover:bg-primary hover:text-white hover:scale-95 relative dark:hover:text-black"
            >
              <img src="/assets/buymeacoffee-icon.svg" alt="Buy Me A Coffee" className="absolute left-6 h-6 w-6" draggable="false" />
              Buy Me A Coffee
            </Link>
          )}

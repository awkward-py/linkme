...
export async function POST(request) {
    ...
    const { username, bio, youtube, insta, face, github, name, snapchat, twitter, linkedin } = await request.json();
    ...
    try {
        ...
        if (findCurrentUser) {
            ...
            return NextResponse.json({ message: "success", name, username, bio, linkedin, twitter, youtube, snapchat, insta, face, github }, { status: 200 });
        } else {
            await User.create({
                name: name,
                username: username,
            ...
            return NextResponse.json({ message: "success", username, name, bio, youtube, snapchat, insta, face, github }, { status: 200 });
        }
    } catch (error) {
